...
func (m *mockTransactionRepo) GetTransactionsByType(ctx context.Context, userId string, page, limit uint64, transaction_type string) ([]domain.Transaction, int64, int, error) {
	return nil, 0, 0, nil
}
